...
class Idcsmartali extends Plugin
{
    ...
    public $info = array(
        ...
        'author'      => '智简魔方',
        'version'     => '2.3.1',
        'help_url'    => 'https://my.idcsmart.com/cart/goods.html?id=817',
        'description_url'    => 'http://doc.idcsmart.com/%E6%99%BA%E7%AE%80%E9%AD%94%E6%96%B9%E8%8A%9D%E9%BA%BB%E4%BF%A1%E7%94%A8.html',
    );
    ...
    public function IdcsmartaliPerson($certifi)
    {
        ...
        if ($res1['status'] == 200){
            ...
            <div class='left-box2'>
                <div class='sao-icon-box'>
                    <img src='/plugins/addon/idcsmart_certification/template/clientarea/pc/default/img/account/sao-icon.png' alt=''>
                </div>
                <div class='sao-text'>
                    <p>打开手机支付宝</p>
                    <p>扫一扫继续认证</p>
        ...
        <img src='/plugins/addon/idcsmart_certification/template/clientarea/pc/default/img/account/zfb-img.png' alt=''>
        </div>
            <script src='https://cdn.staticfile.org/jquery/1.10.2/jquery.min.js'></script>
            <script>
                var timer = null
                var captchaTimer = setTimeout(() => { onLoad() }, 500)
                window.isCodeFinshed = false
