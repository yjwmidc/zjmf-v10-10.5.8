        ...
        if ($is_admin) {
            ...
            '>
                <div class='captcha-content' style=''>
                    ...
                    <div class=\"captcha-main\" style=\"display: flex;flex-direction: row;margin-top: .31rem;padding-left: 10px;\">
                        <input id='captcha-input' type=\"text\" placeholder=\"请输入验证码\" style=\"padding-left: 10px;\">
                        <img id=\"captcha-img\" src=\"" . $base64 . "\">
                    </div>
