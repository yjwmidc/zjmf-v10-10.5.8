...
class LocalOss extends Plugin
{
     ...
     * @param int param.timeout - 超时时间，时间戳，单位秒 required
    ...
    public function LocalOssDownload($param)
    {
        ...
        $website_url = !empty($clientarea_url = configuration('clientarea_url'))?$clientarea_url:configuration('website_url');
        $url = $website_url."/console/v1/resource?fid={$str}&expires={$expires}&rand_str={$res['rand_str']}&sign={$res['signature']}";
