...
class CloudController{
	...
	*/
			...
			if($result['status'] == 200){
				...
				system_notice([
					...
					'task_data' => [
						...
						'template_param'=>[
                            'action' => lang_plugins('res_whmcs_cloud_on'),
                        ],
					],
				]);
			}
			...
			if($result['status'] == 200){
				...
				system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_whmcs_cloud_off'),
                        ],
					],
				]);
			}
			...
			if($result['status'] == 200){
				...
				system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_whmcs_cloud_reboot'),
                        ],
					],
				]);
			}
			...
			if($result['status'] == 200){
				...
				system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_whmcs_cloud_hard_off'),
                        ],
					],
				]);
			}
			...
			if($result['status'] == 200){
				...
				system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_whmcs_cloud_hard_reboot'),
                        ],
					],
				]);
     ...
     * @title 批量操作
     * @desc 批量操作
     * @url /console/v1/rewhmcs_cloud/batch_operate
     * @method  POST
     * @author theworld
     * @version v1
    ...
    public function batchOperate()
    {
        ...
        foreach ($id as $v) {
        	$res = reserver_api('WhmcsCloud', 'cloud', $action[$param['action']], ['id' => (int)$v]);
			...
			if($result['status'] == 200){
				...
				system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_whmcs_cloud_vnc'),
                        ],
					],
				]);
			}
			...
			if($result['status'] == 200){
				...
				system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_whmcs_cloud_reset_password'),
                        ],
					],
				]);
			}
			...
			if($result['status'] == 200){
				...
				system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_whmcs_cloud_rescue'),
                        ],
					],
				]);
			}
			...
			if($result['status'] == 200){
				...
				system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_whmcs_cloud_exit_rescue'),
                        ],
					],
				]);
			}
			...
			if($result['status'] == 200){
				...
				system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_whmcs_cloud_reinstall'),
                        ],
					],
				]);
			}
			...
			if($result['status'] == 200){
				...
				system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_whmcs_cloud_create_snap'),
                        ],
					],
				]);
			}
			...
			if($result['status'] == 200){
				...
				system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_whmcs_cloud_snap_restore'),
                        ],
					],
				]);
			}
			...
			if($result['status'] == 200){
				...
				system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_whmcs_cloud_delete_snap'),
                        ],
					],
				]);
			}
			...
			if($result['status'] == 200){
				...
				system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_whmcs_cloud_create_backup'),
                        ],
					],
				]);
			}
			...
			if($result['status'] == 200){
				...
				system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_whmcs_cloud_backup_restore'),
                        ],
					],
				]);
			}
			...
			if($result['status'] == 200){
				...
				system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_whmcs_cloud_delete_backup'),
                        ],
					],
				]);
			}
