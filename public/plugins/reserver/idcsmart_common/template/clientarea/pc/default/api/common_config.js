...
function getCommonDetail(id) {
  return Axios.get(`/reidcsmart_common/product/${id}/configoption`);
}
// 修改配置计算价格
...
function getCommonList(params) {
  return Axios.get(`/reidcsmart_common/host`, { params });
}
// 产品列表
function getCommonListDetail(id) {
  return Axios.get(`/reidcsmart_common/host/${id}/configoption`);
}
// 通用详情
function getCommonDetail(id) {
...
function upgradePage(host_id) {
  return Axios.get(`/reidcsmart_common/host/${host_id}/upgrade`);
}
// 购买应用升降级页面
...
function upgradeConfigPage(host_id) {
  return Axios.get(`/reidcsmart_common/host/${host_id}/upgrade_config`);
}
//产品升降级异步获取升降级价格
function upgradePrice(id, params) {
  return Axios.post(`/reidcsmart_common/host/${id}/sync_upgrade_price`, params);
}
// 修改配置重新计算周期价格
function calculate(params) {
  return Axios.post(
    `/reidcsmart_common/product/${params.id}/configoption/calculate`,
    params
  );
}
//产品配置升降级异步获取升降级价格
function syncUpgradePrice(id, params) {
  return Axios.post(
    `/reidcsmart_common/host/${id}/sync_upgrade_config_price`,
    params
  );
}
// 产品升降级
function upgradeHost(id, params) {
  return Axios.post(`/reidcsmart_common/host/${id}/upgrade`, params);
}
//产品配置升降级
function upgradeConfigHost(host_id, params) {
  return Axios.post(
    `/reidcsmart_common/host/${host_id}/upgrade_config`,
    params
  );
}
...
function chartList(params) {
  return Axios.post(
    `/reidcsmart_common/host/${params.id}/configoption/chart`,
    params
  );
}
...
function provision(params) {
  return Axios.post(
    `/reidcsmart_common/host/${params.id}/provision/${params.func}`,
    params
  );
}
// 前台产品内页自定义页面输出
function configArea(params) {
  return Axios.get(`/reidcsmart_common/host/${params.id}/configoption/area`, {
    params,
  });
}
function getLog(params) {
  return Axios.get(`/reidcsmart_common/${params.id}/log`, { params });
}
