...
Route::group('console/v1',function (){
    ...
    Route::get('remf_cloud/:id/download_rdp', "\\reserver\\mf_cloud\\controller\\home\\CloudController@downloadRdp");
    Route::get('remf_cloud/:id/whether_renew', "\\reserver\\mf_cloud\\controller\\home\\CloudController@whetherRenew");
    ...
    // Route::get('remf_cloud/:id/package/config/price', "\\reserver\\mf_cloud\\controller\\home\\CloudController@calPackageConfigPrice");
    // Route::post('remf_cloud/:id/package/config/order', "\\reserver\\mf_cloud\\controller\\home\\CloudController@createPackageConfigOrder");
    ...
    Route::get('remf_cloud/:id/upgrade_defence_config', "\\reserver\\mf_cloud\\controller\\home\\CloudController@defenceConfig");
    Route::get('remf_cloud/:id/upgrade_defence/price', "\\reserver\\mf_cloud\\controller\\home\\CloudController@calDefencePrice");
    Route::post('remf_cloud/:id/upgrade_defence/order', "\\reserver\\mf_cloud\\controller\\home\\CloudController@createDefenceOrder");
...
Route::group(DIR_ADMIN . '/v1',function (){
    ...
    Route::get('remf_cloud/:id/flow', "\\reserver\\mf_cloud\\controller\\admin\\CloudController@flowDetail");
