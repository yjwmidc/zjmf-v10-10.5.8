  ...
  methods: {
    async getModuleFlowInfo() {
      try {
        ...
        const leave_num =
          total_num == 0
            ? lang.module_no_limit
            : Number(total_num - used_num).toFixed(2);
        total_num =
          total_num === 0 ? lang.module_no_limit : Number(total_num).toFixed(2);
        base_flow =
          base_flow === 0 ? lang.module_no_limit : Number(base_flow).toFixed(2);
