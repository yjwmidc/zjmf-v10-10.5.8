...
function getNatAcl(params) {
  return Axios.get(`/remf_cloud/${params.id}/nat_acl`);
}
function addNatAcl(params) {
  return Axios.post(`/remf_cloud/${params.id}/nat_acl`, params);
}
function delNatAcl(params) {
  return Axios.delete(`/remf_cloud/${params.id}/nat_acl`, {params});
}
// NAT建站
function getNatWeb(params) {
  return Axios.get(`/remf_cloud/${params.id}/nat_web`);
}
function addNatWeb(params) {
  return Axios.post(`/remf_cloud/${params.id}/nat_web`, params);
}
function delNatWeb(params) {
  return Axios.delete(`/remf_cloud/${params.id}/nat_web`, {params});
}
...
function changeSimulatePhysical(params) {
  return Axios.post(
    `/remf_cloud/${params.id}/simulate_physical_machine`,
    params
  );
}
...
function ipv6List(params) {
  return Axios.get(`/remf_cloud/${params.id}/ipv6`, {params});
}

// 下载RDP
function apiDownloadRdp(params) {
  return Axios.get(`/remf_cloud/${params.id}/download_rdp`, {params});
}
