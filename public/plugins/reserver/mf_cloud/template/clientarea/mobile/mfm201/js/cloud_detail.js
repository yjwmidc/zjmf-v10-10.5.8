    ...
    return {
      ...
      powerStatusArr: {
        on: {
          ...
          icon: `/plugins/reserver/mf_cloud/template/clientarea/mobile/mfm201/img/cloud/on.svg`,
        },
        off: {
          text: lang.common_cloud_text11,
          icon: `/plugins/reserver/mf_cloud/template/clientarea/mobile/mfm201/img/cloud/off.svg`,
        },
        operating: {
          text: lang.common_cloud_text12,
          icon: `/plugins/reserver/mf_cloud/template/clientarea/mobile/mfm201/img/cloud/operating.svg`,
        },
        fault: {
          text: lang.common_cloud_text86,
          icon: `/plugins/reserver/mf_cloud/template/clientarea/mobile/mfm201/img/cloud/fault.svg`,
        },
        suspend: {
          text: lang.common_cloud_text87,
          icon: `/plugins/reserver/mf_cloud/template/clientarea/mobile/mfm201/img/cloud/suspended.svg`,
        },
      },
      // 显示重装系统弹窗
    ...
    getManualOs() {
      manualResourceOs(this.id).then((res) => {
        if (res.data.status === 200) {
          ...
          this.osIcon =
            "/plugins/reserver/mf_cloud/template/clientarea/mobile/mfm201/img/mf_cloud/" +
            this.osData[0]?.icon +
            ".svg";
