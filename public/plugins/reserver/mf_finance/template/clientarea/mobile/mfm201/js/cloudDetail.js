...
const app2 = Vue.createApp({
    ...
    return {
      ...
      powerStatusArr: {
        on: {
          ...
          icon: `/plugins/reserver/mf_finance/template/clientarea/mobile/mfm201/img/cloud/on.svg`,
        },
        off: {
          text: lang.common_cloud_text11,
          icon: `/plugins/reserver/mf_finance/template/clientarea/mobile/mfm201/img/cloud/off.svg`,
        },
        operating: {
          text: lang.common_cloud_text12,
          icon: `/plugins/reserver/mf_finance/template/clientarea/mobile/mfm201/img/cloud/operating.svg`,
        },
        fault: {
          text: lang.common_cloud_text86,
          icon: `/plugins/reserver/mf_finance/template/clientarea/mobile/mfm201/img/cloud/fault.svg`,
        },
        suspend: {
          text: lang.common_cloud_text87,
          icon: `/plugins/reserver/mf_finance/template/clientarea/mobile/mfm201/img/cloud/suspended.svg`,
        },
      },
      loading1: false,
      loading2: false,
  ...
  methods: {
    ...
    handelSelectImg() {
      ...
      this.osIcon =
        "/plugins/reserver/mf_finance/template/clientarea/mobile/mfm201/img/mf_cloud/" +
        e[0].group +
        ".svg";
