    ...
    return {
      ...
      powerStatus: {
        on: {
          ...
          icon: `/plugins/reserver/mf_dcim/template/clientarea/mobile/mfm201/img/mf_dcim/on.svg`,
        },
        off: {
          text: lang.common_cloud_text11,
          icon: `/plugins/reserver/mf_dcim/template/clientarea/mobile/mfm201/img/mf_dcim/off.svg`,
        },
        operating: {
          text: lang.common_cloud_text12,
          icon: `/plugins/reserver/mf_dcim/template/clientarea/mobile/mfm201/img/mf_dcim/operating.svg`,
        },
        fault: {
          text: lang.common_cloud_text86,
          icon: `/plugins/reserver/mf_dcim/template/clientarea/mobile/mfm201/img/mf_dcim/fault.svg`,
        },
        suspend: {
          text: lang.common_cloud_text87,
          icon: `/plugins/reserver/mf_dcim/template/clientarea/mobile/mfm201/img/mf_dcim/suspended.svg`,
        },
        pending: {
