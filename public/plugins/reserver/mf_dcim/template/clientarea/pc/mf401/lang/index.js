(function () {
  const module_lang = {
    "zh-cn": {
      ...
      common_cloud_tip33:
        "1、长度6位及以上 2、只能输入大写字母、小写字母、数字、~!@#$&* ()_ -+=| {}[];:<>?,./中的特殊符号3、不能以“/”开头4、必须包含小写字母a~z，大写字母A~Z",
    ...
    "en-us": {
      ...
      common_cloud_tip33:
        ...
        " 4. Must contain lowercase letters a~z, uppercase letters A~Z",
      ...
      no_model_tip: "No models available, click",
      no_model_tip1: "Return to order page",
    ...
    "zh-hk": {
      ...
      common_cloud_tip33:
        "1、長度6位以上2、只能輸入大寫字母、小寫字母、數字、~!@#$&* ()_ -+=| {}[];:<>?,./中的特殊 符號3、不能以「/」開頭4、必須包含小寫字母a~z，大寫字母A~Z",
