...
Route::group('console/v1',function (){
	...
	Route::get('remf_dcim/:id/upgrade_defence_config', "\\reserver\\mf_dcim\\controller\\home\\CloudController@defenceConfig");
    Route::get('remf_dcim/:id/upgrade_defence/price', "\\reserver\\mf_dcim\\controller\\home\\CloudController@calDefencePrice");
    Route::post('remf_dcim/:id/upgrade_defence/order', "\\reserver\\mf_dcim\\controller\\home\\CloudController@createDefenceOrder");
...
Route::group(DIR_ADMIN . '/v1',function (){
    ...
    Route::get('remf_dcim/:id/flow', "\\reserver\\mf_dcim\\controller\\admin\\CloudController@flowDetail");
