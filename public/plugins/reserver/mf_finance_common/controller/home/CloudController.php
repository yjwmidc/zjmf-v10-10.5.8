...
class CloudController
{
    ...
    public function hostList(){
        ...
        // theworld 获取TAB数量
        $whereCount[] = ['up.res_module', '=', 'mf_finance_common'];
            ...
            if($result['status'] == 200){
                ...
                system_notice([
					...
					'task_data' => [
						...
						'template_param'=>[
                            'action' => lang_plugins('res_mf_finance_common_on'),
                        ],
					],
				]);
            }
            ...
            if($result['status'] == 200){
                ...
                system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_mf_finance_common_off'),
                        ],
					],
				]);
            }
            ...
            if($result['status'] == 200){
                ...
                system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_mf_finance_common_reboot'),
                        ],
					],
				]);
            }
            ...
            if($result['status'] == 200){
                ...
                system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_mf_finance_common_hard_off'),
                        ],
					],
				]);
            }
            ...
            if($result['status'] == 200){
                ...
                system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_mf_finance_common_hard_reboot'),
                        ],
					],
				]);
            }
            ...
            if($result['status'] == 200){
                ...
                system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_mf_finance_common_reinstall'),
                        ],
					],
				]);
            }
            ...
            if($result['status'] == 200){
                ...
                system_notice([
					...
					'task_data' => [
						...
						'host_id' 	=> $HostModel['id'],
						'template_param'=>[
                            'action' => lang_plugins('res_mf_finance_common_reset_password'),
                        ],
					],
				]);
            }
