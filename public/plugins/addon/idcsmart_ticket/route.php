...
# 前台，不需要登录
Route::group('console/v1/api',function (){
    Route::put('ticket/:id/status', "\\addon\\idcsmart_ticket\\controller\\clientarea\\TicketController@updateStatus")
        ->append(['_plugin'=>'idcsmart_ticket','_controller'=>'ticket','_action'=>'update_status']);
    Route::put('ticket/:id/reply', "\\addon\\idcsmart_ticket\\controller\\clientarea\\TicketController@updateReply")
        ->append(['_plugin'=>'idcsmart_ticket','_controller'=>'ticket','_action'=>'update_reply']);
    Route::delete('ticket/:id/reply', "\\addon\\idcsmart_ticket\\controller\\clientarea\\TicketController@deleteReply")
        ->append(['_plugin'=>'idcsmart_ticket','_controller'=>'ticket','_action'=>'delete_reply']);
    Route::post('ticket/:id/reply', "\\addon\\idcsmart_ticket\\controller\\clientarea\\TicketController@createReply")
        ->append(['_plugin'=>'idcsmart_ticket','_controller'=>'ticket','_action'=>'create_reply']);
})
...
Route::group('console/v1',function (){
    ...
    # 获取工单附件资源
    Route::get('ticket/resource', "\\addon\\idcsmart_ticket\\controller\\clientarea\\TicketController@resource")
        ->append(['_plugin'=>'idcsmart_ticket','_controller'=>'ticket','_action'=>'resource']);# 带上默认参数,可以使用继承控制器app\admin\controller\PluginBaseController的一些通用方法,也可以不追加这些参数(_plugin插件名称C风格,_controller控制器名称C风格,_action方法名称C风格)
    ...
    # 工单通知设置
    Route::get('ticket/config', "\\addon\\idcsmart_ticket\\controller\\clientarea\\TicketController@ticketConfig")
        ->append(['_plugin'=>'idcsmart_ticket','_controller'=>'ticket','_action'=>'ticket_config']);
    Route::put('ticket/:id/processing', "\\addon\\idcsmart_ticket\\controller\\clientarea\\TicketController@processing")
        ->append(['_plugin'=>'idcsmart_ticket','_controller'=>'ticket','_action'=>'processing']);
    Route::put('ticket/:id/terminate', "\\addon\\idcsmart_ticket\\controller\\clientarea\\TicketController@terminate")
        ->append(['_plugin'=>'idcsmart_ticket','_controller'=>'ticket','_action'=>'terminate']);
})
    ->middleware(\app\http\middleware\ParamFilter::class)
...
Route::group(DIR_ADMIN . '/v1',function (){
    ...
    Route::get('ticket/supplier/product', "\\addon\\idcsmart_ticket\\controller\\TicketDeliveryController@supplierProductList")
        ->append(['_plugin'=>'idcsmart_ticket','_controller'=>'ticket_delivery','_action'=>'supplier_product_list']);
    Route::get('ticket/delivery', "\\addon\\idcsmart_ticket\\controller\\TicketDeliveryController@ticketDeliveryList")
        ->append(['_plugin'=>'idcsmart_ticket','_controller'=>'ticket_delivery','_action'=>'ticket_delivery_list']);
    Route::post('ticket/delivery', "\\addon\\idcsmart_ticket\\controller\\TicketDeliveryController@create")
        ->append(['_plugin'=>'idcsmart_ticket','_controller'=>'ticket_delivery','_action'=>'create']);
    Route::put('ticket/delivery/:id', "\\addon\\idcsmart_ticket\\controller\\TicketDeliveryController@update")
        ->append(['_plugin'=>'idcsmart_ticket','_controller'=>'ticket_delivery','_action'=>'update']);
    Route::delete('ticket/delivery/:id', "\\addon\\idcsmart_ticket\\controller\\TicketDeliveryController@delete")
        ->append(['_plugin'=>'idcsmart_ticket','_controller'=>'ticket_delivery','_action'=>'delete']);
    Route::get('ticket/delivery/:id', "\\addon\\idcsmart_ticket\\controller\\TicketDeliveryController@index")
        ->append(['_plugin'=>'idcsmart_ticket','_controller'=>'ticket_delivery','_action'=>'index']);

    Route::post('ticket/:id/delivery/manual', "\\addon\\idcsmart_ticket\\controller\\TicketController@manualDelivery")
        ->append(['_plugin'=>'idcsmart_ticket','_controller'=>'ticket','_action'=>'manual_delivery']);
    Route::post('ticket/:id/delivery/terminate', "\\addon\\idcsmart_ticket\\controller\\TicketController@terminateDelivery")
        ->append(['_plugin'=>'idcsmart_ticket','_controller'=>'ticket','_action'=>'manual_delivery']);
    Route::post('ticket/:id/delivery/active', "\\addon\\idcsmart_ticket\\controller\\TicketController@activeDelivery")
        ->append(['_plugin'=>'idcsmart_ticket','_controller'=>'ticket','_action'=>'active_delivery']);
