...
Route::group('console/v1',function (){
    ...
    Route::post('security_group/:id/host', "\\addon\\idcsmart_cloud\\controller\\clientarea\\SecurityGroupController@batchLinkSecurityGroup")
    ->append(['_plugin'=>'idcsmart_cloud','_controller'=>'security_group','_action'=>'batch_link_security_group']);
    # 安全组规则
