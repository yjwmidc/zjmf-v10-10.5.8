    ...
    new Vue({
      ...
      data() {
        return {
          ...
          listData: [],
          typeOption: [
            { value: "Artificial", label: lang.refund_op_text2 },
            { value: "Auto", label: lang.refund_op_text3 },
          ],
          requireOption: [
            { value: "First", label: lang.refund_op_text4 },
            { value: "Same", label: lang.refund_op_text5 },
            { value: "", label: "--" },
          ],
          ruleOption: [
            { value: "Day", label: lang.refund_op_text8 },
            { value: "Month", label: lang.refund_op_text9 },
            { value: "Ratio", label: lang.refund_op_text10 },
          ],
          actionOption: [
            { value: "Suspend", label: lang.refund_op_text11 },
            { value: "Terminate", label: lang.refund_op_text12 },
          ],
          columns: [
            {
              colKey: "product_name",
            ...
            {
              colKey: "require",
              title: lang.refund_require,
              cell: "require",
              ellipsis: true,
            },
            {
              colKey: "rule",
              title: lang.refund_rule,
              cell: "rule",
              ellipsis: true,
            },
      ...
      methods: {
        /**
         * @param {string} optionList 选项列表 data中的数据
         * @param {string} value 值
         * @returns {string} 选项标签
         */
        calcOptionLabel(optionList, value) {
          return this[optionList].find((item) => item.value === value).label;
        },
        // 时间格式转换
        formatDate(date) {
          const str1 = [
        ...
        //获取商品列表list
        async getList() {
          let list = await getRefundList(this.params);
