...
return [
    ...
    'refund_to_client_credit' => '退款至用户余额',
    ...
    'refund_refund_host_fail' => '{client}停用产品{host}失败，失败原因：{reason}',
    ...
    'client_refund_success_send_mail' => '产品退款成功,发送邮件',
    'client_refund_success_send_sms' => '产品退款成功,发送短信',
    'admin_refund_reject_send_mail' => '产品退款驳回,发送邮件',
    'admin_refund_reject_send_sms' => '产品退款驳回,发送短信',
    'client_refund_cancel_send_mail' => '产品取消请求,发送邮件',
    'client_refund_cancel_send_sms' => '产品取消请求,发送短信',
    'client_create_refund_send_mail' => '产品退款申请,发送邮件',
    'client_create_refund_send_sms' => '产品退款申请,发送短信',
