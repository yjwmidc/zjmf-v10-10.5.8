(function () {
  const plugin_lang = {
    "zh-cn": {
      ...
      realname_text83: "此次认证需要支付",
      realname_text84: "支付并认证",
      realname_text85: "已支付",
    },
    "en-us": {
      ...
      realname_text83: "This certification requires payment",
      realname_text84: "Payment and authentication",
      realname_text85: "Paid",
    },
    "zh-hk": {
      realname_text1: "實名認證",
      ...
      realname_text83: "此次認證需要支付",
      realname_text84: "支付並認證",
      realname_text85: "已支付",
    },
  };
