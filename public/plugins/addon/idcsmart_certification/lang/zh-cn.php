...
return [
    ...
    'certification_order_unpaid' => '您已有未支付实名认证订单，请先完成支付',
    'certification_need_pay ' => '此次实名认证需要收费，请先完成支付',
    'certification_order_paid' => '您的实名认证订单已支付，可直接提交认证资料',
    'certification_do_not_need_order' => '您的实名认证不需要生成订单',
    'certification_order_amount_certification' => '实名认证费用',
];
