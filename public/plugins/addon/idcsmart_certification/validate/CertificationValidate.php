...
class CertificationValidate extends Validate
{
    protected $rule = [
        ...
        'certification_company_open'=> 'require|in:0,1',
        ...
        'certification_uncertified_cannot_buy_product'=> 'in:0,1',
        'certification_age'=> 'egt:0',
        'certification_age_open'=> 'require|in:0,1',
        'certification_recharge'=> 'require|in:0,1',
    ];
    ...
    protected $scene = [
        ...
        'set_config' => ['certification_open', 'certification_company_open','certification_approval', 'certification_notice' ,'certification_update_client_name',
