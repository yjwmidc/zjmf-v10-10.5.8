...
class CertificationController extends PluginBaseController
{
     ...
     * @return int certification_company_open - 是否开启企业认证:1开启默认，0关
     ...
     * @return int certification_age_open - 是否开启低于某岁数驳回
     * @return int certification_age - 低于某岁数驳回
     * @return int certification_recharge - 未认证无法充值
     */
     ...
     * @param int certification_company_open - 是否开启企业认证:1开启默认，0关
     ...
     * @param int certification_age_open - 是否开启低于某岁数驳回 required
     * @param int certification_age - 低于某岁数驳回 required
     * @param int certification_recharge - 未认证无法充值 required
     */
    public function setConfig()
    {
        $param = $this->request->only(['certification_open', 'certification_company_open','certification_approval', 'certification_notice' ,'certification_update_client_name',
            'certification_upload', 'certification_update_client_phone', 'certification_uncertified_cannot_buy_product','certification_age','certification_age_open','certification_recharge']);
