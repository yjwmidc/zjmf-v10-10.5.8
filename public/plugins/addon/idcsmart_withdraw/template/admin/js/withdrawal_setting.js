    ...
    new Vue({
        ...
        return {
          ...
          rules: {
            name: [
              {
                required: true,
                message: lang.input + lang.withdrawal_way,
                type: "error",
              },
              {
      ...
      methods: {
        ...
        addItem(type) {
          ...
          this.diaTitle =
            type === "way"
              ? `${lang.add}${lang.withdrawal_way}`
              : `${lang.add}${lang.dismiss_the_reason}`;
        },
        // 编辑
        editItem(row, type) {
          this.optType = type;
          ...
          this.diaTitle =
            type === "way"
              ? `${lang.edit}${lang.withdrawal_way}`
              : `${lang.edit}${lang.dismiss_the_reason}`;
        },
        // 删除
        delItem(row, type) {
          this.optType = type;
