        ...
        return {
          ...
          rules: {
            source: [
              {
                required: true,
                message: lang.select + lang.withdrawal_source,
                type: "error",
              },
            ],
            method: [
              {
                required: true,
                message: lang.select + lang.withdrawal_way,
                type: "error",
              },
            ],
            process: [
              {
                required: true,
                message: lang.select + lang.withdrawal_process,
                type: "error",
              },
            ],
            cycle: [
              {
                required: true,
                message: lang.select + lang.withdrawal_cycle_limit,
                type: "error",
              },
            ],
            withdraw_fee_type: [
              {
                required: true,
                message: lang.select + lang.withdraw_fee_type,
                type: "error",
              },
            ],
            cycle_limit: [
      ...
      methods: {
        ...
        async getRuleDetail() {
          try {
            ...
            temp.min = Number(temp.min) || null;
            temp.max = Number(temp.max) || null;
