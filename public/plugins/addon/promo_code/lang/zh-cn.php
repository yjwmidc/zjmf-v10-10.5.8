...
return [
    ...
    'addon_promo_code_client_level_is_not_install' => '未安装用户等级插件，不支持选择用户未拥有指定用户等级条件',
    'addon_promo_code_client_level_is_not_exist' => '用户等级不存在',
    ...
    'addon_promo_code_only_not_have_client_level_client' => '尚未达到优惠码使用条件',
    ...
    'auth_product_promo_code_delete_promo_code' => '删除优惠码',
