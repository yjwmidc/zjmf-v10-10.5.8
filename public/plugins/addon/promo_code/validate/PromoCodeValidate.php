...
class PromoCodeValidate extends Validate
{
	protected $rule = [
		...
		'client_type' 		  => 'require|in:all,new,old,not_have_client_level',
        'client_level'        => 'array',
    ...
    protected $message  =   [
        ...
        'client_level.array'            => 'param_error',
    ...
    protected $scene = [
        'create' => ['code','type','client_type','client_level','start_time','end_time','products','need_products','max_times','single_user_once','upgrade','host_upgrade','renew','loop','cycle_limit','cycle','notes'],
        'update' => ['id','client_type','client_level','start_time','end_time','products','need_products','max_times','single_user_once','upgrade','host_upgrade','renew','loop','cycle_limit','cycle','notes'],
        'status' => ['status'],
