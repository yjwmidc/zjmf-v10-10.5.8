...
class IdcsmartCommonProductConfigoptionSubController extends BaseController
{
     ...
     * @title 配置子项拖动排序
     * @desc 配置子项拖动排序
     * @url /admin/v1/idcsmart_common/configoption/:configoption_id/sub/order
     * @method  POST
     * @author wyh
     * @version v1
     * @param   int configoption_id - 配置项ID require
    ...
    public function subOrder()
    {
        ...
        $result = $IdcsmartCommonProductConfigoptionSubModel->subOrder($param);
