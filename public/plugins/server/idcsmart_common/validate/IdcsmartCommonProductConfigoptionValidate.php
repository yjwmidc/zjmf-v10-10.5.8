...
class IdcsmartCommonProductConfigoptionValidate extends Validate
{
    ...
    protected $scene = [
        'create' => ['option_name','option_type','option_param','unit','allow_repeat','fee_type','max_repeat','qty_min','qty_max','hidden','configoption_id','set_son_product','pay_type','free','qty_change'],
        'update' => ['option_name','option_type','option_param','unit','allow_repeat','fee_type','max_repeat','qty_min','qty_max','hidden','configoption_id','set_son_product','pay_type','free','qty_change'],
    ];
