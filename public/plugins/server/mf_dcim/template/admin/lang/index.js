(function () {
  ...
  const module_lang = {
    "zh-cn": {
      ...
      mf_tip18: "带宽与计算限制",
      mf_tip19:
        "注意：用户订购时，若命中规则中的某一配置项，则系统将根据限制规则展示配置",
      ...
      mf_tip43: " 前台显示的IP数量",
      mf_tip44: " 前台显示的带宽",
      mf_tip45: "请勾选要删除的操作系统",
      mf_tip46: "确认删除已选中的操作系统？",
      mf_total: "总量计费",
      batch_delete: "批量删除",
      mf_way: "方式",
    ...
    "zh-hk": {
      ...
      mf_tip18: "帶寬與計算限制",
      mf_tip19:
        "註意：用戶訂購時，若命中規則中的某壹配置項，則系統將根據限制規則展示配置",
      ...
      mf_tip42: "輸入NC後，可輸入用於前臺顯示的帶寬",
      mf_tip43: " 前臺顯示的IP數量",
      mf_tip44: " 前臺顯示的帶寬",
      mf_tip45: "請勾選要刪除的操作系統",
      mf_tip46: "確認刪除已選中的操作系統？",
      mf_total: "總量計費",
      batch_delete: "批量刪除",
      mf_way: "方式",
      ...
      mf_choose_tip:
        "勾選需要限制的配置項。單次限制配置項，至少兩個。選擇配置項後，配置對應規則",
    ...
    "en-us": {
      ...
      mf_tip19:
        "Note: When users place an order, if a configuration item in the rule is hit, the system will display the configuration according to the restriction rule",
      ...
      mf_tip45: "Please check the operating system you want to delete",
      mf_tip46: "Confirm to delete the selected operating system?",
      ...
      Max_value_tip: "Maximum value, no input is considered infinite",
      mf_model: "Model",
      mf_copy: "Copy",
      mf_public_ip: "Public IP",
      mf_limitless: "Infinite",
      mf_choose_config: "Select configuration item",
      mf_choose_tip:
        "Check the configuration items that need to be restricted. At least two configuration items should be restricted at a time. After selecting the configuration items, configure the corresponding rules.",
      mf_fill_condition: "When the condition is met",
      ...
      dcim_on: "Power on",
      dcim_off: "Power off",
      dcim_suspend: "Suspend",
      dcim_operating: "Operating",
      dcim_fault: "Fault",
      /* Firewall */
      ...
      mf_tip63:
        "3. After the network is upgraded, users are not allowed to upgrade or downgrade the package",
      mf_tip64: "Automatically synchronize DCIM inventory",
      mf_tip65: "Inventory",
      ontrial_text1: "Trial settings",
      ontrial_text2: "On",
      ontrial_text3: "Off",
      ontrial_text4: "Start trial model",
