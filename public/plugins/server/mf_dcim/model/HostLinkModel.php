                            ...
                            if(!$match){
                                if(isset($homeLineConfig['bw'])){
                                    foreach($homeLineConfig['bw'] as $vv){
                                        if($vv['type'] == 'radio'){
                                            $match = $LimitRuleModel->limitRuleResultMatch(['bw'=>$limitResult['bw']], ['bw'=>$vv['value']], ['bw']);
                                            if($match){
                            ...
                            if(!$match){
                                if(isset($homeLineConfig['flow'])){
                                    foreach($homeLineConfig['flow'] as $vv){
                                        if($vv['type'] == 'radio'){
                                            $match = $LimitRuleModel->limitRuleResultMatch(['flow'=>$limitResult['flow']], ['flow'=>$vv['value']], ['flow']);
                                            if($match){
