...
Route::group('console/v1',function (){
	...
	Route::get('mf_dcim/:id/upgrade_defence_config', "\\server\\mf_dcim\\controller\\home\\CloudController@defenceConfig");
	Route::get('mf_dcim/:id/upgrade_defence/price', "\\server\\mf_dcim\\controller\\home\\CloudController@calDefencePrice");
	Route::post('mf_dcim/:id/upgrade_defence/order', "\\server\\mf_dcim\\controller\\home\\CloudController@createDefenceOrder");
...
Route::group(DIR_ADMIN . '/v1',function (){
	...
	Route::put('mf_dcim/model_config/:id/ontrial', "\\server\\mf_dcim\\controller\\admin\\ModelConfigController@updateOntrial");
	...
	Route::put('mf_dcim/image/:id/drag', "\\server\\mf_dcim\\controller\\admin\\ImageController@dragToSort");
	Route::get('mf_dcim/local_image/sync', "\\server\\mf_dcim\\controller\\admin\\ImageController@localImageSync");
	...
	Route::get('mf_dcim/firewall_defence_rule', "\\server\\mf_dcim\\controller\\admin\\ConfigController@firewallDefenceRule");
	Route::get('mf_dcim/firewall_defence_rule', "\\server\\mf_dcim\\controller\\admin\\ConfigController@firewallDefenceRule");
	Route::post('mf_dcim/firewall_defence_rule', "\\server\\mf_dcim\\controller\\admin\\ConfigController@importDefenceRule");
	Route::get('mf_dcim/global_defence', "\\server\\mf_dcim\\controller\\admin\\ConfigController@globalDefenceList");
	Route::get('mf_dcim/global_defence/:id', "\\server\\mf_dcim\\controller\\admin\\ConfigController@globalDefenceIndex");
	Route::put('mf_dcim/global_defence/:id', "\\server\\mf_dcim\\controller\\admin\\ConfigController@globalDefenceUpdate");
	Route::delete('mf_dcim/global_defence/:id', "\\server\\mf_dcim\\controller\\admin\\ConfigController@globalDefenceDelete");
	Route::put('mf_dcim/global_defence/:id/drag_sort', "\\server\\mf_dcim\\controller\\admin\\ConfigController@globalDefenceDragSort");
	...
	Route::put('mf_dcim/line/:id/hidden', "\\server\\mf_dcim\\controller\\admin\\LineController@updateHidden");
	...
	Route::post('mf_dcim/line/:id/firewall_defence_rule', "\\server\\mf_dcim\\controller\\admin\\LineController@importDefenceRule");
    ...
    Route::put('mf_dcim/line_defence/:id/drag_sort', "\\server\\mf_dcim\\controller\\admin\\LineController@lineDefenceDragSort");
	...
	Route::get('mf_dcim/:id/flow', "\\server\\mf_dcim\\controller\\admin\\CloudController@flowDetail");
