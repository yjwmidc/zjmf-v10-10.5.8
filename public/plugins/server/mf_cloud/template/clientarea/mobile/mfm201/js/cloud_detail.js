...
const app2 = Vue.createApp({
    ...
    return {
      ...
      powerStatusArr: {
        on: {
          ...
          icon: `/plugins/server/mf_cloud/template/clientarea/mobile/mfm201/img/cloud/on.svg`,
        },
        off: {
          text: lang.common_cloud_text11,
          icon: `/plugins/server/mf_cloud/template/clientarea/mobile/mfm201/img/cloud/off.svg`,
        },
        operating: {
          text: lang.common_cloud_text12,
          icon: `/plugins/server/mf_cloud/template/clientarea/mobile/mfm201/img/cloud/operating.svg`,
        },
        fault: {
          text: lang.common_cloud_text86,
          icon: `/plugins/server/mf_cloud/template/clientarea/mobile/mfm201/img/cloud/fault.svg`,
        },
        suspend: {
          text: lang.common_cloud_text87,
          icon: `/plugins/server/mf_cloud/template/clientarea/mobile/mfm201/img/cloud/suspended.svg`,
        },
      },
      // 显示重装系统弹窗
  ...
  methods: {
    ...
    sliderChange (val, item) {
      ...
      console.log('range1111', val, item, this.mapToRange(val, arr, item.min_value, val > item.size));
