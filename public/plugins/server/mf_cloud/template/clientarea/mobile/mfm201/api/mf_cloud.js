...
function getSystemList(params) {
  return Axios.get(`/product/${params.id}/mf_cloud/image`);
}
// 获取商品配置所有周期价格
function getDuration(params) {
  return Axios.post(`/product/${params.id}/mf_cloud/duration`, params);
}
// 修改配置计算价格
...
function getVpc(params) {
  return Axios.get(`/product/${params.id}/mf_cloud/vpc_network/search`, {
    params,
  });
}
// 用户等级折扣
