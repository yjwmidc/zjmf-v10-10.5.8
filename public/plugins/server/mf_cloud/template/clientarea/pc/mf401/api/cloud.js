...
function dataCenter(id) {
  return Axios.get(`/product/${id}/mf_cloud/data_center`);
}
/* 产品列表 */
...
function cloudDetail(params) {
  return Axios.get(`/mf_cloud/${params.id}`, {params});
}
// cloud日志
function getLog(params) {
  return Axios.get(`/mf_cloud/${params.id}/log`, {params});
}
// 快照列表
function snapshotList(params) {
  return Axios.get(`/mf_cloud/${params.id}/snapshot`, {params});
}
// 创建快照
function createSnapshot(params) {
  return Axios.post(`/mf_cloud/${params.id}/snapshot`, params);
}
// 快照还原
function restoreSnapshot(params) {
  return Axios.post(`/mf_cloud/${params.id}/snapshot/restore`, params);
}

// 获取快照/备份数量升降级价格
function backupConfig(params) {
  return Axios.get(`/mf_cloud/${params.id}/backup_config`, {params});
}

// 生成快照/备份数量升降级订单
function backupOrder(params) {
  return Axios.post(`/mf_cloud/${params.id}/backup_config/order`, params);
}

// 删除快照
function delSnapshot(params) {
  return Axios.delete(
    `/mf_cloud/${params.id}/snapshot/${params.snapshot_id}`,
    params
  );
}
// 备份列表
function backupList(params) {
  return Axios.get(`/mf_cloud/${params.id}/backup`, {params});
}
// 创建备份
function createBackup(params) {
  return Axios.post(`/mf_cloud/${params.id}/backup`, params);
}
// 备份还原
function restoreBackup(params) {
  return Axios.post(`/mf_cloud/${params.id}/backup/restore`, params);
}
// 删除备份
function delBackup(params) {
  return Axios.delete(
    `/mf_cloud/${params.id}/backup/${params.backup_id}`,
    params
  );
}
...
function getDiskList(params) {
  return Axios.get(`/mf_cloud/${params.id}/disk`, {params});
}
// 获取其它设置
function config(params) {
  return Axios.get(`/product/${params.product_id}/mf_cloud/config`, {params});
}
// 获取购买磁盘价格
function diskPrice(params) {
  return Axios.post(`/mf_cloud/${params.id}/disk/price`, params);
}

// 生成购买磁盘订单
function diskOrder(params) {
  return Axios.post(`/mf_cloud/${params.id}/disk/order`, params);
}

// 获取扩容磁盘价格
function expanPrice(params) {
  return Axios.post(`/mf_cloud/${params.id}/disk/resize`, params);
}
// 生成磁盘扩容订单
function diskExpanOrder(params) {
  return Axios.post(`/mf_cloud/${params.id}/disk/resize/order`, params);
}
...
function image(params) {
  return Axios.get(`/product/${params.id}/mf_cloud/image`, {params});
}
// 检查产品是否购买过镜像
function checkImage(params) {
  return Axios.get(`/mf_cloud/${params.id}/image/check`, {params});
}
// 生成购买镜像订单
function imageOrder(params) {
  return Axios.post(`/mf_cloud/${params.id}/image/order`, params);
}
// 获取SSH秘钥列表
...
function reinstall(params) {
  return Axios.post(`/mf_cloud/${params.id}/reinstall`, params);
}
// 获取实例状态
function cloudStatus(params) {
  return Axios.get(`/mf_cloud/${params.id}/status`, {params});
}
// 开机
function powerOn(params) {
  return Axios.post(`/mf_cloud/${params.id}/on`, params);
}
// 关机
function powerOff(params) {
  return Axios.post(`/mf_cloud/${params.id}/off`, params);
}
// 获取控制台地址
function vncUrl(params) {
  return Axios.post(`/mf_cloud/${params.id}/vnc`, params);
}
// 救援模式
function rescue(params) {
  return Axios.post(`/mf_cloud/${params.id}/rescue`, params);
}
// 退出救援模式
function exitRescue(params) {
  return Axios.post(`/mf_cloud/${params.id}/rescue/exit`, params);
}
// 获取升降级订购页套餐
function upgradePackage(params) {
  return Axios.get(`/product/${params.product_id}/mf_cloud/package`, {
    params,
  });
}
// 获取升降级套餐价格
function upgradePackagePrice(type, params) {
  if (type === "custom") {
    return Axios.get(`/mf_cloud/${params.id}/common_config`, {params});
  } else if (type === "package") {
    return Axios.get(`/mf_cloud/${params.id}/recommend_config/price`, {params});
  }
}
// 生成升降级套餐订单
function upgradeOrder(type, params) {
  if (type === "custom") {
    return Axios.post(`/mf_cloud/${params.id}/common_config/order`, params);
  } else if (type === "package") {
    return Axios.post(`/mf_cloud/${params.id}/recommend_config/order`, params);
  }
}
// 获取是否救援系统
function remoteInfo(params) {
  return Axios.get(`/mf_cloud/${params.id}/remote_info`, {params});
}
// 重启
function reboot(params) {
  return Axios.post(`/mf_cloud/${params.id}/reboot`, params);
}
// 强制重启
function hardReboot(params) {
  return Axios.post(`/mf_cloud/${params.id}/hard_reboot`, params);
}
// 强制关机
function hardOff(params) {
  return Axios.post(`/mf_cloud/${params.id}/hard_off`, params);
}
// 重置密码
function resetPassword(params) {
  return Axios.post(`/mf_cloud/${params.id}/reset_password`, params);
}
...
function ipList(params) {
  return Axios.get(`/mf_cloud/${params.id}/ip`, {params});
}
...
function chartList(params) {
  return Axios.get(`/mf_cloud/${params.id}/chart`, {params});
}

// 获取网络流量
function getFlow(params) {
  return Axios.get(`/mf_cloud/${params.id}/flow`, {params});
}
...
function unmount(params) {
  return Axios.post(
    `/mf_cloud/${params.id}/disk/${params.disk_id}/unmount`,
    params
  );
}
...
function mount(params) {
  return Axios.post(
    `/mf_cloud/${params.id}/disk/${params.disk_id}/mount`,
    params
  );
}
...
function realData(id) {
  return Axios.get(`/mf_cloud/${id}/real_data`);
}
// 获取订购页面配置
function getOrderConfig(params) {
  return Axios.get(`/product/${params.id}/mf_cloud/order_page`, {params});
}
// 获取线路配置
function getLineConfig(params) {
  return Axios.get(`/product/${params.id}/mf_cloud/line/${params.line_id}`, {
    params,
  });
}
// 获取附加IP价格
function ipPrice(params) {
  return Axios.get(`/mf_cloud/${params.id}/ip_num`, {params});
}
// 生成附加IP订单
...
function vpcNetwork(params) {
  return Axios.get(`/mf_cloud/${params.id}/vpc_network`, {params});
}
// 切换实例VPC网络
function changeVpc(params) {
  return Axios.put(`/mf_cloud/${params.id}/vpc_network`, params, {
    timeout: 1000 * 60 * 10,
  });
}
...
function delVpc(params) {
  return Axios.delete(
    `/mf_cloud/${params.id}/vpc_network/${params.vpc_network_id}`
  );
}
//创建VPC网络
function addVpcNet(params) {
  return Axios.post(`/mf_cloud/${params.id}/vpc_network`, params);
}
// 安全组列表
...
function getNatAcl(params) {
  return Axios.get(`/mf_cloud/${params.id}/nat_acl`);
}
function addNatAcl(params) {
  return Axios.post(`/mf_cloud/${params.id}/nat_acl`, params);
}
function delNatAcl(params) {
  return Axios.delete(`/mf_cloud/${params.id}/nat_acl`, {params});
}
// NAT建站
function getNatWeb(params) {
  return Axios.get(`/mf_cloud/${params.id}/nat_web`);
}
function addNatWeb(params) {
  return Axios.post(`/mf_cloud/${params.id}/nat_web`, params);
}
function delNatWeb(params) {
  return Axios.delete(`/mf_cloud/${params.id}/nat_web`, {params});
}
...
function getPackageList(params) {
  return Axios.get(`/mf_cloud/${params.id}/recommend_config`);
}

// 模拟物理机运行
function changeSimulatePhysical(params) {
  return Axios.post(`/mf_cloud/${params.id}/simulate_physical_machine`, params);
}

// IPv6
function ipv6List(params) {
  return Axios.get(`/mf_cloud/${params.id}/ipv6`, {params});
}

// 拉取手动资源镜像
function manualResourceOs(id) {
  return Axios.get(`/manual_resource/${id}/os`, {id});
}
// 获取VPC可分配产品列表
function getUsableVpcNetwork(params) {
  return Axios.get(`/mf_cloud/vpc_network/host`, {params});
}
...
// 下载RDP
function apiDownloadRdp(params) {
  return Axios.get(`/mf_cloud/${params.id}/download_rdp`, {params});
}
