    ...
    public function dataCenterList($param)
    {
        ...
        if(!empty($dataCenter)){
            ...
            $line = LineModel::alias('l')
                    ->field('l.id,l.data_center_id,l.name,l.bill_type,l.hidden')
    ...
    public function orderPage($param)
    {
        ...
        if(!empty($country)){
            ...
            if(!empty($city)){
                ...
                $line = LineModel::field('id,name,data_center_id,bill_type,defence_enable,order_default_defence,sync_firewall_rule')->whereIn('data_center_id', $dataCenterId)->where('hidden', 0)->order('order,id', 'asc')->select()->toArray();
