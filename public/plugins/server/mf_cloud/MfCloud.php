...
class MfCloud
{
    ...
    {
		return ['display_name'=>'魔方云(自定义配置)', 'version'=>'2.3.4'];
	}
  ...
  `rand_ssh_port` tinyint(3) NOT NULL DEFAULT '0' COMMENT 'SSH端口设置(0=默认,1=随机端口,2=指定端口)',
  ...
  `manual_manage` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '手动管理商品',
  ...
  `order_default_defence` varchar(100) NOT NULL DEFAULT '0' COMMENT '订购默认防御',
  PRIMARY KEY (`id`),
  ...
  `power_status` varchar(30) NOT NULL DEFAULT '' COMMENT '电源状态,废弃',
