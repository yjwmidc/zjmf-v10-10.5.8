...
class LineValidate extends Validate
{
    ...
    protected $scene = [
        'create' => ['data_center_id','name','bill_type','bw_ip_group','defence_enable','defence_ip_group','ip_enable','link_clone','bw_data','flow_data','defence_data','ip_data','order','ipv6_enable','sync_firewall_rule'],
        'update' => ['id','name','bw_ip_group','defence_enable','defence_ip_group','ip_enable','link_clone','order','ipv6_enable','sync_firewall_rule','order_default_defence'],
