        ...
        <t-tabs v-model="tab" placement="left" style="margin-top: 20px;" @change="handleTabChange">
          <t-tab-panel value="1" :label="lang.product_set_text63">
            <div style="margin-left: 20px;">
              ...
              <t-pagination v-if="params.total > 0" show-jumper :total="params.total" :page-size="params.limit"
                :current="params.page" :page-size-options="pageSizeOptions" @change="changePage">
              </t-pagination>
            </div>
          </t-tab-panel>
          <t-tab-panel value="2" :label="lang.product_set_text64">
            <div style="margin-left: 20px;">
              <div class="top-opt">
                ...
                <t-button @click="createNewSys">{{lang.product_set_text85}}</t-button>
              </div>
