    ...
    <t-card class="list-card-container">
      ...
      <div class="api-box">
        <div class="api-switch">
          ...
          <t-switch size="large" v-model="configData.client_create_api" :custom-value="[1,0]"
            @change="changeSwitch"></t-switch>
        ...
        <template v-if="configData.client_create_api_type !== 0 && configData.client_create_api !== 0">
          ...
          <t-table row-key="id" :data="data" size="medium" :columns="columns" :hover="hover" :loading="loading"
            :table-layout="tableLayout ? 'auto' : 'fixed'" display-type="fixed-width" @sort-change="sortChange"
            :hide-sort-tips="true">
            ...
            <template #certification="{row}">
              <t-tooltip :show-arrow="false" theme="light">
                <span
                  slot="content">{{!row.certification ? lang.real_tip8 : row.certification_type === 'person' ? lang.real_tip9 : lang.real_tip10}}</span>
