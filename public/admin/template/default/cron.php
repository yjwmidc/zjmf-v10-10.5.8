          ...
          <div class="item-box">
            ...
            <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 60 }">
              <t-col :xs="12" :xl="6">
                ...
                <t-form-item :label="lang.setting_text76">
                  <t-switch size="medium" :custom-value="[1,0]" v-model="formData.task_fail_retry_open">
                  </t-switch>
                  <span class="tip">{{lang.setting_text77}}</span>
                  <t-input-number v-model="formData.task_fail_retry_times" theme="normal" :min="0"></t-input-number>
            ...
            <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 60 }">
              <t-col :xs="12" :xl="6">
                <t-form-item :label="lang.setting_text81">
                  <t-switch size="medium" :custom-value="[1,0]"
                    v-model="formData.cron_system_log_delete_swhitch"></t-switch>
                  <span>{{lang.setting_text82}}</span>
                  <t-input-number v-model="formData.cron_system_log_delete_day" :min="0" theme="normal">
                  </t-input-number>
                  <span>{{lang.setting_text83}},{{lang.setting_text84}}</span>
                </t-form-item>
                <t-form-item :label="lang.setting_text85">
                  <t-switch size="medium" :custom-value="[1,0]"
                    v-model="formData.cron_sms_log_delete_swhitch"></t-switch>
                  <span>{{lang.setting_text82}}</span>
                  <t-input-number v-model="formData.cron_sms_log_delete_day" theme="normal" :min="0"></t-input-number>
                  <span>{{lang.setting_text83}},{{lang.setting_text84}}</span>
                </t-form-item>
                <t-form-item :label="lang.setting_text86">

                  <t-switch size="medium" :custom-value="[1,0]"
                    v-model="formData.cron_email_log_delete_swhitch"></t-switch>
                  <span>{{lang.setting_text82}}</span>
                  <t-input-number v-model="formData.cron_email_log_delete_day" theme="normal" :min="0"></t-input-number>
                  <span>{{lang.setting_text83}},{{lang.setting_text84}}</span>
                </t-form-item>
              </t-col>
            </t-row>
