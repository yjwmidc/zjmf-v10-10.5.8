...
// 获取代理商余额预警设置
function apiGetCreditWarning(params) {
  return Axios.get(`/configuration/supplier_credit_warning`, {params});
}

// 保存代理商余额预警设置
function apiUpdateCreditWarning(params) {
  return Axios.put(`/configuration/supplier_credit_warning`, params);
}

// 刷新供应商余额
function apiRefreshSupplierCredit(params) {
  return Axios.get(`/supplier/${params.id}/credit`, {params});
}
