    ...
    <t-card class="list-card-container">
      ...
      <div class="box">
        <t-form :data="formData" :rules="rules" label-align="top" :label-width="80" ref="formValidatorStatus"
          @submit="onSubmit">
          <t-tabs v-model="value" placement="left" @change="changeTab">
              ...
              <div>
                <t-form-item name="cart_instruction">
                  <template #label>
                    ...
                    <t-switch size="medium" v-model="formData.cart_instruction" :custom-value="[1,0]"
              ...
              <div style="margin-top: 10px;">
                <t-form-item name="cart_change_product" :label="lang.nav_text17">
                  <template #label>
                    ...
                    <t-switch size="medium" v-model="formData.cart_change_product" :custom-value="[1,0]"></t-switch>
                  </template>
                </t-form-item>
              </div>
            </t-tab-panel>
