    ...
    <div class="box scrollbar">
      ...
      <div class="top-search">
        <div class="input-search">
          <t-input v-model="params.keywords" class="search-input" :placeholder="lang.search_placeholder" @keypress.enter.native="search" :on-clear="clearKey" clearable>
            <t-icon size="20px" name="search" slot="suffix" @click="search" class="com-search-btn" />
          </t-input>
        </div>
