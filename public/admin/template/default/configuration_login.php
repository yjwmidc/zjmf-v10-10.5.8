              ...
              <div class="tab-content">
                ...
                <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 60 }">
                  ...
                  <t-col :xs="24" :xl="6" :md="12">
                    <t-form-item :label="lang.support_email_type">
                      <t-radio-group name="limit_email_suffix" v-model="formData.limit_email_suffix">
                        <t-radio :value="1">{{lang.yes}}</t-radio>
                        <t-radio :value="0">{{lang.login_no}}</t-radio>
                      </t-radio-group>
                      <t-input style="width: 400px;" v-if="formData.limit_email_suffix == '1'"
                        v-model="formData.email_suffix" :placeholder="lang.support_email_tip"></t-input>
                    </t-form-item>
                  </t-col>
                </t-row>
                <t-row :gutter="{ xs: 8, sm: 16, md: 24, lg: 32, xl: 32, xxl: 60 }">
                  ...
                  <t-col :xs="12" :xl="3" :md="6">
                    <t-form-item name="home_login_ip_exception_verify">
                      <div slot="label" class="custom-label">
                        ...
                        <t-tooltip placement="top-right" :content="lang.setting_text10" :show-arrow="false"
                          theme="light">
                          <t-icon name="help-circle" size="18px" />
                        </t-tooltip>
                      </div>
                      <t-select style="width: 100%;" v-model="formData.home_login_ip_exception_verify"
                        ...
                        <t-option v-for="item in homeVerifyList" :value="item.value" :label="item.label"
                          :key="item.value">
                        </t-option>
                      </t-select>
                    </t-form-item>
                  ...
                  <t-col :xs="12" :xl="3" :md="6">
                    <t-form-item name="first_login_method" :label="lang.setting_text87">
