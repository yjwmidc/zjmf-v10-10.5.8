    ...
    <t-card class="list-card-container">
      <div class="common-header">
        <div class="header-left">
          <div class="com-transparent change_log" @click="jump" v-permission="'auth_system_interface_email_notice_email_template_create_template'">
      ...
      <t-table row-key="id" :data="data" size="medium" :columns="columns" :hover="hover" :loading="loading" :table-layout="tableLayout ? 'auto' : 'fixed'" @sort-change="sortChange" :hide-sort-tips="hideSortTips">
        ...
        <template #op="{row}">
          <t-tooltip :content="lang.edit" :show-arrow="false" theme="light">
            <t-icon name="edit-1" class="common-look" @click="updateHandler(row)" v-permission="'auth_system_interface_email_notice_email_template_update_template'">
            </t-icon>
          </t-tooltip>
          <t-tooltip :content="lang.test" :show-arrow="false" theme="light">
            <a class="common-look" @click="testHandler(row)" v-permission="'auth_system_interface_email_notice_email_template_test_template'">
          ...
          <t-tooltip :content="lang.delete" :show-arrow="false" theme="light">
            <t-icon name="delete" class="common-look" @click="deleteHandler(row)" v-permission="'auth_system_interface_email_notice_email_template_delete_template'">
            </t-icon>
          </t-tooltip>
        </template>
      </t-table>
