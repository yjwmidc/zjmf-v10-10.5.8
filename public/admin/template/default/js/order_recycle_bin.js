  ...
  window.onload = function () {
    ...
    const adminOperateVue = new Vue({
      ...
      methods: {
        ...
        // 清空
        async handleClear(remember_operate_password = 0) {
          ...
          try {
            ...
            const res = await clearRecycleList({
              admin_operate_password,
              admin_operate_methods: "handleClear",
        ...
        // 删除
        async handleDelete(remember_operate_password = 0) {
          const admin_operate_password = this.admin_operate_password;
          this.admin_operate_password = "";
          try {
            const id = [];
            ...
            const params = {
              id,
              admin_operate_password,
              admin_operate_methods: "handleDelete",
              remember_operate_password,
            };
            this.submitLoading = true;
        ...
        async getRecycleSetting() {
          try {
            ...
            temp.order_recycle_bin_save_days = Number(
              temp.order_recycle_bin_save_days
            );
        ...
        search() {
          ...
          if (this.delRange.length > 0) {
            ...
            this.params.end_recycle_time =
              new Date(this.delRange[1].replace(/-/g, "/")).getTime() / 1000 ||
              "";
          } else {
            this.params.start_recycle_time = "";
            this.params.end_recycle_time = "";
