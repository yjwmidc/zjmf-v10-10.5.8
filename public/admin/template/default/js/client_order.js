  ...
  window.onload = function () {
    ...
    const adminOperateVue = new Vue({
      ...
      methods: {
        ...
        lookDetail(id) {
          if (!this.$checkPermission("auth_user_detail_order_check_order")) {
            return;
          }
          sessionStorage.currentOrderUrl = window.location.href;
          location.href = `order_details.htm?id=${id}`;
        },
        async getPlugin() {
          try {
        ...
        changeUser(id) {
          this.id = id;
          location.href = `client_order.htm?id=${this.id}`;
        },
        async getClintList() {
          try {
        ...
        addOrder() {
          location.href = `create_order.htm?id=${this.id}`;
        },
