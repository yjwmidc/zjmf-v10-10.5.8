      ...
      methods: {
        ...
        async getSetting() {
          try {
            ...
            this.formData.prohibit_user_information_changes =
              res.data.data.prohibit_user_information_changes;
            this.formData.ip_white_list = res.data.data.ip_white_list;

            this.user_information_fields =
              res.data.data.user_information_fields;
            this.formData.home_show_deleted_host = String(
              res.data.data.home_show_deleted_host
            );
            this.formData.clientarea_logo_url_blank = String(
              res.data.data.clientarea_logo_url_blank
            );
