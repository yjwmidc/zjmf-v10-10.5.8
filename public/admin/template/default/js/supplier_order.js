(function (window, undefined) {
  ...
  window.onload = function () {
    const template = document.getElementsByClassName("supplier_order")[0];
    ...
    new Vue({
      ...
      created() {
        ...
        temp.id && (this.params.supplier_id = temp.id);
        this.getOrderList();
        this.getSellInfo();
      },
      mounted() {
        ...
        window.onresize = () => {
          ...
          timer = setTimeout(() => {
            this.maxHeight =
              document.getElementById("content").clientHeight - 270;
            clearTimeout(timer);
            timer = null;
          }, 300);
        };
