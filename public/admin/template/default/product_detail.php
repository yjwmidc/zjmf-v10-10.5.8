              ...
              <t-row :gutter="{ xs: 0, xxl: 30 }" class="dis-box">
                <t-col :xs="12" :xl="6">
                  ...
                  <t-form-item :label="lang.open_notice">
                    <t-radio-group name="creating_notice_sms" v-model="formData.creating_notice_sms"
                ...
                <t-col :xs="12" :xl="6">
                  ...
                  <t-form-item :label="lang.open_notice">
                    <t-radio-group name="creating_notice_sms" v-model="formData.creating_notice_mail"
                      :options="checkOptions">
                    </t-radio-group>
                  </t-form-item>
                </t-col>
                <t-col :xs="12" :xl="6" class="half">
                  ...
                  <t-form-item :label="lang.choose_template">
                    <t-select v-model="formData.creating_notice_sms_api_template">
                      <t-option v-for="item in smsTempList[creatingName]" :value="item.id" :label="item.title"
                        :key="item.id">
                      </t-option>
                    </t-select>
                  </t-form-item>
                ...
                <t-col :xs="12" :xl="6" class="half">
                  ...
                  <t-form-item :label="lang.choose_template">
                    <t-select v-model="formData.created_notice_sms_api_template">
                      <t-option v-for="item in smsTempList[createdName]" :value="item.id" :label="item.title"
                        :key="item.id">
                      </t-option>
                    </t-select>
                  </t-form-item>
