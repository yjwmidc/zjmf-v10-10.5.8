    ...
    <t-card class="list-card-container">
      ...
      <div class="common-header">
        ...
        <div class="right-search">
          <template v-if="!isAdvance">
            ...
            <t-input v-model="params.keywords" class="search-input" :placeholder="lang.input" @keypress.enter.native="search" clearable v-show="searchType !== 'product_id'">
            </t-input>
            ...
            @keypress.enter.native="search" clearable style="margin-right: 0;">
            </t-input>
      ...
      <div class="advanced" v-show="isAdvance">
        <div class="search">
          ...
          <com-tree-select class="search-input" v-show="searchType === 'product_id'" :value="params.product_id" @choosepro="choosePro"></com-tree-select>
          <t-input v-model="params.username" class="search-input" :placeholder="`${lang.input}${lang.username}`" @keypress.enter.native="search" clearable>
          </t-input>
          <t-input :placeholder="lang.money" v-model="params.amount" @keypress.enter.native="search"></t-input>
      ...
      <!-- bot-opt -->
      <div class="bot-opt">
        <t-button @click="handleRecyle('restore', true)" v-permission="'auth_business_order_recycle_bin_recover_order'">{{lang.batch_restore}}</t-button>
        <t-button @click="handleRecyle('delete', true)" v-permission="'auth_business_order_recycle_bin_delete_order'">{{lang.batch_delete}}</t-button>
        <t-button @click="handleRecyle('lock', true)" v-permission="'auth_business_order_recycle_bin_lock_order'">{{lang.order_lock}}</t-button>
        <t-button @click="handleRecyle('unlock', true)" v-permission="'auth_business_order_recycle_bin_unlock_order'">{{lang.order_unlock}}</t-button>
      </div>
    </t-card>
    ...
    <t-dialog :header="optTitle" :visible.sync="recycleVisble" :footer="false" class="recycle-dialog">
      <div class="con">
        <div :class="`icon ${recycleType}`">
          <svg>
            <use :xlink:href="`#icon-${recycleType}`"></use>
          </svg>
        </div>
        <div class="text">
