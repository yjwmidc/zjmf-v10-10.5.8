...
return [
    ...
    'register_phone_is_not_open' => '未開啟手機註冊/登入',
    ...
    'login_without_common_ip_need_verify' => '系統偵測到您此次登入異常，為了確保帳戶安全，請核驗您的身分',
    ...
    'client_recharge' => '用戶充值，會員ID：{client_id}',
    ...
    'log_client_login_operate_password_error' => '{client}登入系統失敗,異常驗證失敗',
    'log_client_login_operate_password_success' => '{client}登入系統成功,異常驗證成功',
    ...
    'notice_open_in' => '是否接收通知必填值0,1',
    'notice_method_require' => '接收方式必填',
    'notice_method_in' => '接收方式為all,email,sms',
    'notice_open' => '是否接收通知',
    'notice_method' => '接收通知方式',
    'notice_open_1' => '開啟',
    'notice_open_0' => '關閉',

    'log_module_sync_account_success' => '{client}的產品{host}資訊同步成功',
    'log_module_sync_account_failed' => '{client}的產品{host}資訊同步失敗',
    'login_email_password_close' => '未開啟郵件信箱密碼登入',
];
