                        ...
                        <el-table v-loading="loading1" @selection-change="handleSelectionChange" :data="dataList1"
                          ...
                          <el-table-column prop="status" :label="lang.finance_label4" width="150">
                            <template slot-scope="scope">
                              ...
                              <!-- 待上传 -->
                              <el-tag v-if="scope.row.status && scope.row.status=='WaitUpload'" class="Wait">
                                {{lang.finance_custom1}}
                              </el-tag>
                              <!-- 待审核 -->
                              <el-tag v-if="scope.row.status && scope.row.status=='WaitReview'" class="Wait">
                                {{lang.finance_custom2}}
                              </el-tag>
                              <!-- 未通过 -->
                              <el-tag v-if="scope.row.status && scope.row.status=='ReviewFail'" class="Unpaid">
