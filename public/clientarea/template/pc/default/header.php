...
<head>
    ...
    <link rel="stylesheet" href="/{$template_catalog}/template/{$public_themes}/css/common/element.css">
    <link rel="stylesheet" href="/{$template_catalog}/template/{$public_themes}/css/common/viewer.min.css">
    ...
    <script src="/{$template_catalog}/template/{$public_themes}/js/common/viewer.min.js"></script>
    ...
    <script src="/{$template_catalog}/template/{$public_themes}/components/proofDialog/proofDialog.js"></script>
