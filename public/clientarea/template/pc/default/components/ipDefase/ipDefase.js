...
<div>
  ...
  <div class="ip-defase-box">
    <div class="fire-list-search">
      ...
      <el-button type="primary" style="background-color: #0058ff;border-color: #0058ff;" @click="search">{{lang.ipDefase_text3}}</el-button>
    </div>
        ...
        <div class="footer-top">
          ...
          <div class="money" v-loading="upgradePriceLoading">
            ...
            <div class="code-box" v-if="false">
              <!-- 代金券 -->
              <cash-coupon ref="cashRef2" v-show="isShowCash && !cashObj.code" :currency_prefix="commonData.currency_prefix"
                @use-cash="upUseCash" scene="upgrade" :product_id="[product_id]" :price="upParams.original_price">
              </cash-coupon>
              <!-- 优惠码 -->
            ...
            <div class="code-number-text">
              ...
              <div class="cash-codeNumber" v-show="cashObj.code">
                {{ cashObj.code }}<i class="el-icon-circle-close remove-discountCode" @click="upRemoveCashCode()"></i>
              </div>
            </div>
          </div>
        </div>
  ...
  mounted() {
    ...
    this.isShowCash = havePlugin("IdcsmartVoucher");
  },
  filters: {
    formateTime(time) {
      if (time && time !== 0) {
  ...
  methods: {
    ...
    upRemoveCashCode() {
      this.$refs.cashRef2 && this.$refs.cashRef2.closePopver();
      this.cashObj = {};
