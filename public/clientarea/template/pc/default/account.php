            ...
            <el-dialog width="6.8rem" :visible.sync="isShowPeratedia" :show-close=false :close-on-click-modal=false>
              ...
              <div class="mian-form">
                <el-form :model="operateData" label-position="top" :rules="operaRules" ref="operaForm"
                  ...
                  <el-form-item :label="lang.account_label11" prop="origin_operate_password"
                    v-if="orginAcountData.set_operate_password">
                    <el-input type="password" v-model="operateData.origin_operate_password" autocomplete="off"
                      :placeholder="lang.account_tips1">
                    </el-input>
                  </el-form-item>
                  ...
                  <div class="form-tips" style="color: #606266; font-size: 0.14rem;">
                    <span style="color: #F56C6C; margin-right: 4px;">*</span>{{lang.account_tips_text8}}
                  </div>
