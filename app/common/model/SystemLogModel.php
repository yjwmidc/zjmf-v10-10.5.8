...
class SystemLogModel extends Model
{
     ...
     * @author theworld
     * @version v1
     * @param string param.type - 类型system:系统日志api:API日志
                    ...
                    foreach ($name as $k=>$v){
                        ...
                        if ($v == 'client'){
                            if($app=='home'){
                                ...
                                $url = '<a class="el-link el-link--primary is-underline" href="client_detail.htm?client_id=' . $relid . '"><span class="el-link--inner">'.$str1.'</span></a>';
                            }
                        ...
                        elseif ($v == 'host'){
                            ...
                            if($app=='home'){
                                ...
                                $url = '<a class="el-link el-link--primary is-underline" href="host_detail.htm?client_id='.($host['client_id'] ?? 0).'&id=' . $relid . '"><span class="el-link--inner">'.$str1.'</span></a>';
                            }
                        ...
                        elseif ($v == 'product'){
                            if($app=='home'){
                                ...
                                $url = '<a class="el-link el-link--primary is-underline" href="product_detail.htm?id=' . $relid . '"><span class="el-link--inner">'.$str1.'</span></a>';
                            }
                            $value = str_replace($str,$url,$value);
                        }
                        elseif ($v == 'ticket'){
                            if($app=='home'){
                                ...
                                $url = '<a class="el-link el-link--primary is-underline" href="plugin/idcsmart_ticket/ticket_detail.htm?id=' . $relid . '"><span class="el-link--inner">'.$str1.'</span></a>';
                            }
