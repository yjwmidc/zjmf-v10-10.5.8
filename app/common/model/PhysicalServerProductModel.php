...
class PhysicalServerProductModel extends Model
{
    ...
    {
        $list = $this->alias('a')
            ->field('a.id,a.area_id,b.first_area,b.second_area,a.title,a.description,a.cpu,a.memory,a.disk,a.ip_num,a.bandwidth,a.duration,a.tag,a.original_price,a.original_price_unit,a.selling_price,a.selling_price_unit,a.product_id,up.mode')
            ->leftjoin('physical_server_area b', 'b.id=a.area_id')
