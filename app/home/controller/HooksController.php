...
class HooksController
{
     ...
     * @author hh
     * @version v1
     * @param   array param.client_id - 用户ID require
     * @return  array - - 例如:['1'=>['2'=>'男']],1是用户ID,2是用户自定义字段ID
     */
     ...
     * @version v1
     * @param   array param.client_id - 用户ID require
     * @return  string [client_id].name - 用户等级名称,client_id是对应用户ID
     * @return  string [client_id].background_color - 背景颜色,client_id是对应用户ID
     */
     ...
     * @author theworld
     * @version v1
     * @param array list - 默认模板控制器Tab列表 require
     * @param string list[].name - 标识 require
     * @param string list[].title - 标题 require
     * @param string list[].url - 地址 require
     * @return array list - 修改后模板控制器Tab列表
     ...
     * @author theworld
     * @version v1
     * @param   string tpl_name - 当前页面模板名 require
     * @param   string url - 当前页面网址 require
     * @return  string title - 标题
     * @return  string keywords - 关键字
     * @return  string description - 描述
     * @return  int pub_date - 推送时间
     * @return  int up_date - 修改时间
     */
     ...
     * @author theworld
     * @version v1
     * @param   string name - 动作英文标识 require
     */
     ...
     * @author theworld
     * @version v1
     * @param int task_id - 任务ID required
     * @param string type - 名称,sms短信发送,email邮件发送,host_create开通主机,host_suspend暂停主机,host_unsuspend解除暂停主机,host_terminate删除主机,执行在插件中的任务 required
     * @param string task_data - 任务要执行的数据 required
     */
     ...
     * @version v1
     * @param int client_id - 客户ID
     * @return int status - 状态成功200失败400,400时不可查看用户数据
     */
     ...
     * @param string app - home=前台,admin=后台
     ...
     * @version v1
     * @param  int host_id - 产品id
     * @param  string scene_desc - 升级场景描述,如变更配置,购买磁盘
     * @return int status - 状态(200=成功,400=失败)
     * @return string msg - 信息
     */
     ...
     * @author hh
     * @version v1
     * @param  think\Db\Query $query - PluginModel查询对象
     */
     ...
     * @version v1
     * @param  int host_id - 产品ID
     * @param  int old_client_id - 原用户ID
     * @param  int new_client_id - 新用户ID
     */
     ...
     * @param   float refund_gateway - 退款渠道金额
     * @param   float refund_credit - 退款余额金额
     * @param   RefundRecordModel refund_record - 退款记录模型实例
     * @return  int status - 状态码(200=成功,400=失败)
     * @return  string msg - 信息
     */
     ...
     * @author wyh
     * @version v1
     * @param  object product_object - 商品对象
     * @param  string field - 字段,引用传递，最后该钩子字段会与系统字段一起返回
     * @param  array param - 前端所传参数
     * @param  bool clientarea - 是否前台
     */
     ...
     * @author hh
     * @version v1
     * @param  string name - 发送动作
     * @param  array task_data - 任务数据
     * @param  int task_data.order_id - 获取订单/用户相关参数
     * @param  int task_data.host_id - 获取产品/用户相关参数
     * @param  int task_data.client_id - 获取用户相关参数,发送给用户必传
     * @param  int task_data.product_id - 商品ID,当传入正确产品ID并且是商品全局动作时自动添加
     * @param  array task_data.template_param - 模板变量
     * @param  array|null notice_type - 支持的通知方式,NULL代表所有动作都可以
     */
