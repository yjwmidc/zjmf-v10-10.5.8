...
class AccountController extends HomeBaseController
{
     ...
     * @return int account.country_id - 国家ID 
     ...
     * @return bool account.set_operate_password - 是否设置了操作密码
     * @return object account.customfield - 自定义字段 
     * @return string account.currency_prefix - 货币符号
     * @return array account.oauth - 三方登录
     * @return string account.oauth[].name - 标识
     * @return string account.oauth[].title  - 名称
     * @return string account.oauth[].url  - 跳转链接 
     * @return bool account.oauth[].link  - 是否绑定true是false否
     * @return int account.notice_open  - 是否接收短信、邮件通知，1是默认0否
     * @return string account.notice_method  - 通知方式：all所有，email邮件，sms短信
     */
     ...
     * @param   string operate_password - 新操作密码 require
     * @param   string re_operate_password - 重复操作密码 require
     */
