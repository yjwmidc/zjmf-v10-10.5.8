...
class CommonController extends HomeBaseController
{
     ...
     * @return string captcha_client_verify 1 验证手机/邮箱图形验证码开关:1开启0关闭
     * @return string captcha_client_update 1 修改手机/邮箱图形验证码开关:1开启0关闭
     * @return string captcha_client_password_reset 1 重置密码图形验证码开关:1开启0关闭
     * @return string captcha_client_oauth 1 三方登录图形验证码开关:1开启0关闭
     ...
     * @return string clientarea_logo_url_blank - 会员中心LOGO跳转是否打开新页面:1是0否
     ...
     * @return string first_login_method - 首选登录方式(code=验证码,password=密码)
     ...
     * @return int plugin_configuration.idcsmart_sale.register_hide_sale 用户注册时隐藏"我有销售"(0=关闭1=开启)
     */
     ...
     * @param int expires - 过期时间 required
     * @return string
     */
