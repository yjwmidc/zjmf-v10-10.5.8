...
class ProductValidate extends Validate
{
	protected $rule = [
        ...
        'custom_host_name_prefix'           => 'requireIf:custom_host_name,1|alpha|length:1,10',
    ...
    protected $message  =   [
        ...
        'custom_host_name_prefix.alpha'             => 'custom_host_name_prefix_error',
    ...
    protected $scene = [
        ...
        'edit' => ['id','name','hidden','stock_control','qty','description','pay_type','product_id','price','renew_rule'],
