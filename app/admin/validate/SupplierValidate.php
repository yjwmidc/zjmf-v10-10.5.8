...
class SupplierValidate extends Validate
{
    protected $rule = [
        ...
        'type'              => 'require|in:default,whmcs,finance',
        'name'              => 'require|max:50',
        ...
        'contact'           => 'max:1000',
        'notes'             => 'max:1000',
        'auto_update_rate'  => 'require|in:0,1',
        'rate'              => 'float|gt:0',
    ];
    ...
    protected $message = [
        ...
        'auto_update_rate.require'  => 'param_error',
        'auto_update_rate.in'       => 'param_error',
        'rate.float'                => 'supplier_rate_error',
        'rate.gt'                   => 'supplier_rate_error',
    ];

    protected $scene = [
        'create' => ['type', 'name', 'url', 'username', 'token', 'secret', 'contact', 'notes'],
        'update' => ['id', 'type', 'name', 'url', 'username', 'token', 'secret', 'contact', 'notes'],
        'rate' => ['id', 'auto_update_rate', 'rate'],
    ];
}