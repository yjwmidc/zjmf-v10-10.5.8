...
class WebNavController extends AdminBaseController
{
     ...
     * @return int list[].children[].blank - 是否打开新窗口
     */
     ...
     * @param int blank - 是否打开新窗口 required
     */
     ...
     * @method  PUT
     * @param int id - 导航ID required
     * @param int blank - 是否打开新窗口0否1是 required
     */
