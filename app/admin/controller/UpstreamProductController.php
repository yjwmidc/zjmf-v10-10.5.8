...
class UpstreamProductController extends AdminBaseController
{
     ...
     * @return int product.profit_type - 利润方式0百分比1固定金额 
     ...
     * @return string product.renew_profit_percent - 续费利润百分比
     * @return int product.renew_profit_type - 续费利润方式0百分比1固定金额
     * @return string product.upgrade_profit_percent - 升降级利润百分比
     * @return int product.upgrade_profit_type - 升降级利润方式0百分比1固定金额
     */
     ...
     * @param int profit_type - 利润方式0百分比1固定金额 required
     ...
     * @param string mode - 代理模式：only_api仅调用接口，sync同步商品 required
     * @author theworld
     * @version v1
     * @url /admin/v1/upstream/product
     * @method  POST
