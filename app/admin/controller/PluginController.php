...
class PluginController extends AdminBaseController
{
     ...
     * @return string list[].menu_id - 导航ID
     * @return string list[].url - 导航链接
     * @return string list[].module - addon插件,server=模块
     * @return int count - 总数
     */
     ...
     * @version v1
     * @param string name - 标识 required
     * @return boolean has_data - 是否存有数据
     */
     ...
     * @param string name - 插件标识 模块不是主题时必填
     * @param string theme - 主题标识 模块是主题时必填
     */
     ...
     * @author theworld
     * @version v1
     * @param string module - 模块:addon插件gateway支付接口,sms短信接口,mail邮件接口,certification实名接口,server模块,oauth第三方登录,sub_server子模块,widget首页挂件,oss对象存储 required
     * @return array list - 插件列表
     * @return int list[].id - ID
     * @return string list[].name - 名称
     * @return string list[].type - 应用类型addon插件gateway支付接口,sms短信接口,mail邮件接口,certification实名接口,server模块,oauth第三方登录,sub_server子模块,widget首页挂件,oss对象存储
     * @return string list[].version - 版本
