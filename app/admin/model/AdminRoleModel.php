...
class AdminRoleModel extends Model
{
    ...
    public function indexAdminRole($id)
    {
        ...
        if(!empty($adminRole)){
            ...
            $adminRole['auth_widget'] = $AdminRoleWidgetModel->getAllWidget($id);
        }
     ...
     * @param array param.auth_widget - 挂件标识
    ...
    public function createAdminRole($param)
    {
        ...
        $param['auth_widget'] = $param['auth_widget'] ?? [];
        ...
        try{
            ...
            $AdminRoleWidgetModel = new AdminRoleWidgetModel();
            $AdminRoleWidgetModel->adminRoleWidgetSave([
                'admin_role_id' => $adminRole->id,
                'widget'        => $param['auth_widget'] ?? [],
            ]);
    ...
    public function deleteAdminRole($param)
    {
        ...
        try{
            ...
            AdminRoleWidgetModel::where('admin_role_id', $id)->delete();
