...
return [
    ...
    'auto_logout' => 7200,
    // 支持的插件类型
    'plugin_module' => ['addon','gateway','sms','mail','captcha','certification','oauth','oss','invoice'],
    // 模板钩子
    'template_hooks' => [
    ...
    'root_namespace' => [
        ...
        'widget' => WEB_ROOT . 'plugins/widget/',
        'oauth' => WEB_ROOT . 'plugins/oauth/',
        'oss' => WEB_ROOT . 'plugins/oss/',
        'invoice' => WEB_ROOT . 'plugins/invoice/',
        'template' => WEB_ROOT . 'web/',
    ],
    // 订单类型
    'order_type' => [
        'new',          // 新订单
    ...
    // 通知分类
    'notice_setting_type' => [
        'client_account',       // 用户账户管理
        'order_pay',            // 订单与支付管理
        'host',                 // 产品相关
        'credit_limit',         // 信用与授信管理
        'maintenance',          // 运维管理
        'ticket',               // 工单管理
        'finance',              // 财务与发票管理
        'other',                // 其他
